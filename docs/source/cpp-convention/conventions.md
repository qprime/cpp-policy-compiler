...
**Status:** Standard | **Version:** 3.0 | **Scope:** all project C++.
**Companions:** [mechanisms.md](mechanisms.md) · [std/cpp11.md](std/cpp11.md) · [std/cpp17.md](std/cpp17.md) · [std/cpp20.md](std/cpp20.md)

This document exists so that C++ written across every project reads as though one engineer wrote it. Not merely correct — *designed*. Consistent, readable, and correct by construction rather than by test.
